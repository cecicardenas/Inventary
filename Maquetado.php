...
<body style="font-family:Arial, Verdana;background-color:#fff; background-image: url(imagenes/d.jpg);">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px; height: 350px; overflow: hidden; ">
        ...
        <div u="loading" style="position: absolute; top: 0px; left: 0px;">
            ...
            <div style="position: absolute; display: block; background: url(imagenes/loading.gif) no-repeat center center;
                top: 0px; left: 0px; width: 100%; height: 100%;">
            </div>
        </div>
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 380px;
            overflow: hidden;">
            <div>
                <a class=appicon01 style="left: 0px; top: 0px; background-position:0px 0px;" href="Consultar/ConsultarUsario.php">
                    <div class=appiconcb></div>
                    <div class=appiconc>Usarios</div>
                </a>
                <!--<a class=appicon01 style="left: 160px; top: 0px; background-position:-160px 0px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Computadoras</div>
                </a>-->
                ...
                <!--<a class=appicon01 style="left: 480px; top: 0px; background-position:-480px 0px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Correos</div>
                </a>-->
                ...
                <!--<a class=appicon01 style="left: 0px; top: 160px; background-position:0px -160px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Telefonos</div>
                </a>-->
            ...
            <div>
                ...
                <a class=appicon02 style="left: 160px; top: 0px; background-position:-160px 0px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Dispositivos</div>
                </a>
                ...
                <a class=appicon02 style="left: 0px; top: 160px; background-position:0px -160px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Entregas de Equipos</div>
                </a>
                ...
                <a class=appicon02 style="left: 320px; top: 160px; background-position:-320px -160px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Consultas</div>
                </a>
                ...
                <a class=appicon02 style="left: 640px; top: 160px; background-position:-640px -160px;" href="#">
                    <div class=appiconcb></div>
                    <div class=appiconc>Reportes</div>
                </a>
            </div>
